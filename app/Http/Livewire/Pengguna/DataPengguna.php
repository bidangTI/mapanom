...
class DataPengguna extends Component
{
    ...
    {
        $this->dataRoles = Role::where('id', 3)->get();
    }
    ...
    {
        $dataLoadlist = User::with(['level','persyaratan','kategori','permohonan'])->where('roles', 3)->get();
        return view('livewire.pengguna.data-pengguna', compact('dataLoadlist'));
    }
}
