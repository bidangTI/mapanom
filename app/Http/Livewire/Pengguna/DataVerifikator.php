...
class DataVerifikator extends Component
{
    ...
    {
        $this->dataRoles = Role::where('id', 2)->get();
    }
    ...
    {
        $dataLoadlist = User::with(['level'])->where('roles', 2)->get();
        return view('livewire.pengguna.data-verifikator', compact('dataLoadlist'));
    }
}
