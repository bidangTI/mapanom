...
class ListSurvey extends Component
{
    ...
    {
        $dataList = User::with(['kategori', 'persyaratan', 'dokumen', 'ketua', 'sekretaris', 'bendahara', 'pendiri', 'pembina', 'penasihat', 'kategori'])->where('permohonan_id', 3)->get();
        $dataKelurahan = Kelurahan::All();
        $dataKecamatan = Kecamatan::All();
        $dataKota = Kota::All();
        return view('livewire.survey.list-survey', compact('dataList','dataKelurahan', 'dataKecamatan', 'dataKota'));
    }
}
