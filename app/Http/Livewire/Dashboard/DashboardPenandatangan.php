...
class DashboardPenandatangan extends Component
{
    public function render()
    {
        ...
        return view('livewire.dashboard.dashboard-penandatangan', compact('infVerifikasiData', 'infSurvey', 'ajukanTTD', 'ajukanTTDPerubahan', 'Perubahan', 'totalNotifikasi', 'Persyaratan', 'Pengurus', 'Dokumen', 'TotalUser'));
    }
}
