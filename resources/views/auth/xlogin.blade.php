                ...
                <div id="loginform">
                    <div class="logo">
                        <span class="db"><img src="{{ asset('backafs/assets/images/app/logo_login.png') }}"
                                alt="logo" /></span>
                        <br><br>
                        <h5 class="font-medium mb-3"><span style="font-size: 20px">Aplikasi SIPP MAS</span> <br>
                            <span style="font-size: 14px">Badan Kesatuan Bangsa dan Politik</span>
                            <br>
                            <span style="font-size: 14px">Kota Surakarta</span>
                        </h5>
                        @if ($errors->any())
                            @foreach ($errors->all() as $error)
                                <div class="alert alert-danger alert-dismissible bg-danger text-white border-0 fade show"
                                    ...
                                    <strong>User/Password Tidak Sesuai</strong>
                                </div>
                            @endforeach
                        @endif
                    </div>
                        ...
                        <div class="col-12">
                            <form class="form-horizontal mt-3" id="loginform" action="{{ route('login') }}"
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg @error('email') is-invalid @enderror" placeholder="Username"
                                ...
                                <div class="mb-3 text-center">
                                    <div class="col-xs-12 pb-3">
                                        <button class="btn d-block w-100 btn-lg btn-warning font-medium" type="submit">
                                            Masuk
                                        </button>
                                    </div>
                                </div>
