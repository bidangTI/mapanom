                            ...
                            @forelse ($dataList as $Nomer => $varList)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" wire:loading.remove
                                            wire:target="KirimPending('{{ $varList->no_register }}')"
                                            class="btn btn-sm px-40 fs-40 font-small me-1"
                                            wire:click="KirimPending('{{ $varList->no_register }}')">
                                            <span class="badge bg-light-danger text-danger font-medium">Tolak</span>
                                        </button>

                                        <div wire:loading wire:target="KirimPending('{{ $varList->no_register }}')">
                                            <button class="btn btn-sm px-40 fs-40 font-small me-1" type="button"
                                                disabled>
                                                <span class="spinner-border spinner-border-sm" role="status"
                                                    aria-hidden="true"></span>
                                        ...
                                        @if ($varList->status_persyaratan == 'Y' && $varList->status_pengurus == 'Y' && $varList->status_dokumen == 'Y')
                                            <button type="button" wire:loading.remove
                                                wire:target="LanjutSurat('{{ $varList->no_register }}')"
                                                class="btn btn-sm px-40 fs-40 font-small me-1"
                                                wire:click="LanjutSurat('{{ $varList->no_register }}')">
                                                <span class="badge bg-light-success text-success font-medium">Lanjut Proses Surat</span>
                                            </button>

                                            <div wire:loading wire:target="LanjutSurat('{{ $varList->no_register }}')">
                                                <button class="btn btn-sm px-40 fs-40 font-small me-1" type="button"
                                                    disabled>
                                                    <span class="spinner-border spinner-border-sm" role="status"
                                                        aria-hidden="true"></span>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            name="bidang" wire:model.defer="bidang" disabled>
                                        </div>
                                    </div>
                                </div>
