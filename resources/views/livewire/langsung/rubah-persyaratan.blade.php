            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-4 control-label">Nama ORMAS<span style="color:red">*</span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                                        <input type="text"
                                            class="form-control @error('namaormas') is-invalid @enderror" id="namaormas"
                                            name="namaormas" placeholder="Masukkan Nama ORMAS" autocomplete="off"
                                            wire:model.defer="namaormas" disabled>
                                    @else
                                        <input type="text"
                                            class="form-control @error('namaormas') is-invalid @enderror" id="namaormas"
                                            name="namaormas" placeholder="Masukkan Nama ORMAS" autocomplete="off"
                                            wire:model.defer="namaormas">
                                        @error('namaormas')
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                                        <input type="text"
                                            class="form-control @error('singormas') is-invalid @enderror" id="singormas"
                                            name="singormas" placeholder="Masukkan Singkatan ORMAS"
                        ...
                        <div class="mb-3 row">
                            <label class="col-md-4 control-label">Jenis Akta Notaris<span
                                    style="color:red">*</span></label>
                            <div class="col-md-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-4 control-label">Nama Notaris<span style="color:red">*</span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                                        <input type="text"
                                            ...
                                            wire:model.defer="namanotaris" autocomplete="off" disabled>
                                    @else
                                        <input type="text"
                                            class="form-control @error('namanotaris') is-invalid @enderror"
                                            id="namanotaris" name="namanotaris" placeholder="Masukkan Nama Notaris"
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-4 control-label">Nomor Akta Notaris<span
                                    style="color:red">*</span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                                        <input type="text"
                                            class="form-control @error('noakta') is-invalid @enderror" id="noakta"
                                            name="noakta" placeholder="Masukkan Nomor Akta Notaris"
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-4 control-label">Tanggal Akta Notaris<span
                                    style="color:red">*</span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div wire:ignore>
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-4 control-label">Nomor Surat Permohonan<span
                                    style="color:red">*</span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-4 control-label">Tanggal Permohonan<span
                                    style="color:red">*</span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div wire:ignore>
                        ...
                        <div class="mb-3 row">
                            <label class="col-md-4 control-label">Bidang Kegiatan<span
                                    style="color:red">*</span></label>
                            <div class="col-md-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                        ...
                        <div class="mb-3 row">
                            <label class="col-md-4 control-label">Sub Bidang Kegiatan<span
                                    style="color:red">*</span></label>
                            <div class="col-md-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                        ...
                        <div class="mb-3 row">
                            <label class="col-md-4 control-label">Kecamatan<span style="color:red">*</span></label>
                            <div class="col-md-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                                        <select
                        ...
                        <div class="mb-3 row">
                            <label class="col-md-4 control-label">Kelurahan<span style="color:red">*</span></label>
                            <div class="col-md-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                                        <select
                        ...
                        <div class="mb-3 row">
                            <label class="col-md-4 control-label">Kota<span style="color:red">*</span></label>
                            <div class="col-md-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                                        <select class="form-control custom-select @error('kota') is-invalid @enderror"
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-4 control-label">Tempat Pendirian<span
                                    style="color:red">*</span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-4 control-label">Tanggal Pendirian<span
                                    style="color:red">*</span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <div wire:ignore>
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3 row">
                            <label class="col-sm-4 control-label">Nomor SK Kepengurusan<span
                                    style="color:red">*</span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-4 control-label">Keputusan Tertinggi<span
                                    style="color:red">*</span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                        ...
                        <div class="mb-3 row">
                            <label class="col-md-4 control-label">Kepengurusan<span style="color:red">*</span></label>
                            <div class="col-md-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                                        <select
                                            ...
                                            wire:model.defer="kepengurusan" autocomplete="off" disabled>
                                        </select>
                                    @else
                                        <select
                                            class="form-control custom-select @error('kepengurusan') is-invalid @enderror"
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-4 control-label">NPWP<span style="color:red">*</span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                                        <input type="text"
                                            class="form-control @error('npwp') is-invalid @enderror" id="npwp"
                                            name="npwp" wire:model.defer="npwp"
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-4 control-label">Sumber Dana<span style="color:red">*</span></label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                                        <input type="text"
                        ...
                        @foreach ($dataPermohonan as $value)
                            @if (!empty($value->no_register))
                                <div class="mb-3 row">
                                    <label class="col-sm-4 control-label">Tujuan ORMAS<span
                                            style="color:red">*</span></label>
                                    <div class="col-sm-12">
                                        <div wire:ignore>
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-4 control-label">No. SK KEMENKUMHAM/KEMENDAGRI</label>
                            <div class="col-sm-8">
                                <div class="input-group">
                                    @if (empty($this->noreg))
                                        <input type="text"
                                            class="form-control @error('skahu') is-invalid @enderror" id="skahu"
                                            name="skahu" placeholder="Nomor SK" wire:model.defer="skahu"
                                            autocomplete="off" disabled>
                                    @else
                                        <input type="text"
                                            class="form-control @error('skahu') is-invalid @enderror" id="skahu"
