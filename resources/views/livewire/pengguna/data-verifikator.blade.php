<div>
    <div class="card">
        <div class="card-body border-bottom">
            <h4 class="card-title">Form Data Verifikator</h4>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="d-flex mb-4">
                    <button type="button" wire:loading.remove wire:target="AddPengguna"
                        ...
                        wire:click="AddPengguna">Tambah Verifikator
                    </button>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header  modal-colored-header bg-info text-white">
                    <h4 class="modal-title" id="myLargeModalLabel">Form Data Verifikator</h4>
