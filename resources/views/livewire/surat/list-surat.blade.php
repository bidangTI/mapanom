<div>
    <div class="card">
        <div class="card-body border-bottom">
            <h4 class="card-title">Form Surat Keberadaan</h4>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td width="50px">
                                        @if ($varList->status_persyaratan == 'Y' && $varList->status_pengurus == 'Y' && $varList->status_dokumen == 'Y')
                                            @if ($varList->permohonan_id >= 5)
                                            @else
                                                {{-- Beri Nomer Surat --}}
                                                @if (!empty($varList->srtkeberadaan))
                                                    @if ($varList->srtkeberadaan[0]->nomor_surat == null)
                                                        <button type="button" wire:loading.remove
                                                            wire:target="NomorSurat({{ $varList->srtkeberadaan[0]->id }})"
                                                            class="btn btn-sm px-40 fs-40 font-small me-1"
                                                            wire:click="NomorSurat({{ $varList->srtkeberadaan[0]->id }})">
                                                            <span
                                                                class="badge bg-light-danger text-danger font-medium">Ambil
                                                                Nomor</span>
                                                        </button>
                                                    ...
                                                    @else
                                                        <button type="button" wire:loading.remove
                                                            wire:target="GantiNomorSurat({{ $varList->srtkeberadaan[0]->id }})"
                                                            class="btn btn-sm px-40 fs-40 font-small me-1"
                                                            wire:click="GantiNomorSurat({{ $varList->srtkeberadaan[0]->id }})">
                                                            <span
                                                                class="badge bg-light-danger text-danger font-medium">Ganti
                                                                Nomor</span>
                                                        </button>
                                                        ...
                                                        {{-- Terbit Surat --}}
                                                        <button type="button" wire:loading.remove
                                                            wire:target="AjukanTTD('{{ $varList->no_register }}')"
                                                            class="btn btn-sm px-40 fs-40 font-small me-1"
                                                            wire:click="AjukanTTD('{{ $varList->no_register }}')">
                                                            <span
                                                                class="badge bg-light-success text-success font-medium">Ajukan
                                                                Tanda Tangan</span>
                                                        </button>
                                                        <div wire:loading
                                                            wire:target="AjukanTTD('{{ $varList->no_register }}')">
                                                ...
                                                @endif
                                                {{-- <p>
                                                    No. Surat : {{ $varList->srtkeberadaan[0]->nomor_surat }}<br>
                                                    Tgl. Surat :
                                    ...
                                    <td>
                                        @if ($varList->srtkeberadaan->isNotEmpty())
                                            @if ($varList->srtkeberadaan[0]->status == 'A' || $varList->srtkeberadaan[0]->status == 'P')
                                                <span
                                                    class="badge bg-light-warning text-warning font-medium">Proses</span>
                                                <p>
                                                    No. Surat : {{ $varList->srtkeberadaan[0]->nomor_surat }}<br>
                                                    Tgl. Surat :
                                                    {{ \Carbon\Carbon::parse($varList->srtkeberadaan[0]->tanggal_surat)->isoFormat('DD-MM-YYYY') }}
                                                </p>
                                            @elseif ($varList->srtkeberadaan[0]->status == 'B')
                                                <p>
                                                    No. Surat : {{ $varList->srtkeberadaan[0]->nomor_surat }}<br>
                                                    Tgl. Surat :
                                                    @if (!empty($varList->srtkeberadaan[0]->tanggal_surat))
                                                        {{ \Carbon\Carbon::parse($varList->srtkeberadaan[0]->tanggal_surat)->isoFormat('DD-MM-YYYY') }}
                                                    @endif
                                                </p>
                                            @elseif ($varList->srtkeberadaan[0]->status == 'Y')
                                                <span
                                                    class="badge bg-light-success text-success font-medium">Selesai</span>
                                                <p>
                                                    No. Surat : {{ $varList->srtkeberadaan[0]->nomor_surat }}<br>
                                                    Tgl. Surat :
                                                    {{ \Carbon\Carbon::parse($varList->srtkeberadaan[0]->tanggal_surat)->isoFormat('DD-MM-YYYY') }}
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-danger text-white">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="mo     dal" aria-label="Close"
    ...
    {{-- Nomor Surat --}}
    <div wire:ignore.self class="modal fade" id="ModalNomorSurat" tabindex="-1"
