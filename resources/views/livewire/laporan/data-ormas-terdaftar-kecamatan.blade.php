<div>
    <div class="card">
        <div class="card-body border-bottom">
            <h4 class="card-title">Tabel ORMAS Terdaftar PerKecamatan</h4>
        </div>
        <div class="card-body">
            <div class="row">
                <form class="form-horizontal" method="post" wire:submit.prevent="">
                    ...
                    <div class="row">
                        <div class="mb-3 row">
                            <label class="col-md-1 control-label">Kecamatan<span style="color:red">*</span></label>
                            <div class="col-md-2">
                                <div class="input-group">
                                    <select class="form-control custom-select @error('kecamatan') is-invalid @enderror"
                                        style="width: 100%; height:36px;" id="kecamatan" name="kecamatan"
                                        wire:model="kecamatan" autocomplete="off">
                                        <option>--- Pilih ---</option>
                                        @foreach ($dataKecamatan as $res)
                                            <option value="{{ $res->id }}">
                                                {{ $res->nama_kecamatan }}
                                            </option>
                                        @endforeach
