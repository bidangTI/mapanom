<div>
    <div class="card">
        <div class="card-body border-bottom">
            <h4 class="card-title">Tabel ORMAS Terdaftar</h4>
        </div>
        <div class="card-body">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="d-flex">
                            ...
                            <div wire:loading wire:target="cetakPDF">
                                <button class="btn btn-danger rounded-pill px-4 waves-effect waves-light" type="button"
                                    disabled>
        ...
        <div class="card-body">
            <div class="row">
                <div class="table-responsive">
                    <table id="complex_head_col" class="table table-striped table-bordered display text-wrap"
                        style="width:100%">
