    ...
    <div class="card">
        ...
        <div class="table-responsive" style="padding-left: 20px; padding-right: 20px;">
             <div class="d-flex mb-4">
                <button type="button" wire:loading.remove wire:target="tambah_laporan"
                    class="btn btn-info rounded-pill px-4 waves-effect waves-light me-1" wire:click="tambah_laporan">Tambah Laporan
                </button>

                <div wire:loading wire:target="tambah_laporan">
                ...
                <div>
                    {{-- <a href="{{ route('export_xlsx') }}" class="btn btn-success rounded-pill px-4 waves-effect waves-light me-1">xlsx</a>
                    <a href="{{ route('export_csv') }}" class="btn btn-warning rounded-pill px-4 waves-effect waves-light me-1">csv</a> --}}
                    <a href="{{ route('user_pdf') }}" class="btn btn-danger rounded-pill px-4 waves-effect waves-light me-1" style="align:right;">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <button type="button" wire:loading.remove
                                            ...
                                            wire:click="lihat_laporan({{ $res->id }})"><span
                                                class="badge bg-light-success text-success font-medium">Lihat</span>
                                        </button>
                ...
                <form class="form-horizontal" wire:submit.prevent="update_laporan">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-12 row">
                            <label class="col-sm-3 control-label">Dokumentasi<span style="color:red">*</span>
                                <small class="form-control-feedback"><span style="font-style: italic">
                                        <span style="font-size:12px; color:brown">**) File jpg, jpeg, png - Max. 1
                                            mb</span>
                                </small>
                            </label>
