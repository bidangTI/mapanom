    ...
    <div class="row" style="text-align: center; font-size: 12">
        <p>
            <b>
                ...
                Nomor Reg :
                {{ $dataForPDF->srtkeberadaan[0]->nomor_surat }}
            </b>
        </p>
    </div>
    <div class="row" style="text-align: justify; line-height: 2em">
        <p>
            Yang bertanda tangan dibawah ini menerangkan pada hari {{ $dataForPDF->srtkeberadaan[0]->hari }}
            tanggal {{ \Carbon\Carbon::parse($dataForPDF->srtkeberadaan[0]->tanggal_surat)->isoFormat('DD MMMM YYYY') }}
    ...
    <div class="row">
        <table width="500">
            <tr>
                ...
                <td>
                    Surakarta,
                    {{ \Carbon\Carbon::parse($dataForPDF->srtkeberadaan[0]->tanggal_surat)->isoFormat('DD MMMM YYYY') }}<br>
                </td>
            </tr>
        </table>
        <table width="500">
