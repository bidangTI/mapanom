                    ...
                    <div class="ms-auto d-flex no-block align-items-center">
                        <ul class="list-inline fs-2 dl me-3 mb-0">
                            <li class="list-inline-item text-info"><i
                                    class="ri-checkbox-blank-circle-fill align-middle fs-3"></i> Iphone
                            </li>
                            <li class="list-inline-item text-primary"><i
                                    class="ri-checkbox-blank-circle-fill align-middle fs-3"></i> Ipad
                            </li>
                        </ul>
                        <div class="dl">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 d-md-flex d-lg-block justify-content-between">
                        ...
                        <div>
                            ...
                            <h6 class="fw-light text-muted mb-md-0 mt-md-2 mt-lg-0 mt-0">Current Month
                                Sales</h6>
                        </div>
                        <a class="btn btn-info mt-3 p-3 pl-4 pr-4 mb-3" href="javascript:void(0)">Last
                            Month Summary</a>
                    </div>
                ...
                <div class="row mb-0">
                    ...
                    <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                        <div class="d-flex align-items-center">
                            <div class="me-2"><span class="text-orange display-5"><i
                                        class="ri-wallet-2-fill"></i></span></div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                        <div class="d-flex align-items-center">
                            <div class="me-2"><span class="text-cyan display-5"><i
                                        class="ri-money-cny-circle-fill"></i></span></div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-3 mb-md-0">
                        <div class="d-flex align-items-center">
                            <div class="me-2"><span class="text-info display-5"><i
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex align-items-center">
                            <div class="me-2"><span class="text-primary display-5"><i
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-6">
                        ...
                        <ul class="list-style-none">
                            <li class="mt-3 d-flex align-items-center"><i
                                    class="ri-checkbox-blank-circle-fill fs-3 me-2 text-muted fs-2"></i>
                                Open Ratio <span class="ms-auto">45%</span></li>
                            <li class="mt-3 d-flex align-items-center"><i
                                    class="ri-checkbox-blank-circle-fill fs-3 me-1 text-info fs-2"></i>
                                Clicked Ratio <span class="ms-auto">14%</span></li>
                            <li class="mt-3 d-flex align-items-center"><i
                                    class="ri-checkbox-blank-circle-fill fs-3 me-1 text-orange fs-2"></i>
                                Un-Open Ratio <span class="ms-auto">25%</span></li>
                            <li class="mt-3 d-flex align-items-center"><i
                                    class="ri-checkbox-blank-circle-fill fs-3 me-1 text-primary fs-2"></i>
                                Bounced Ratio <span class="ms-auto">17%</span></li>
                        </ul>
                    </div>
                </div>
                <!-- column -->
                ...
                <div class="pt-3 text-center">
                    ...
                    <div class="progress mt-5" style="height:4px;">
                        ...
                        <div class="progress-bar bg-orange" role="progressbar" style="width: 30%" aria-valuenow="30"
                            aria-valuemin="0" aria-valuemax="100"></div>
                        <div class="progress-bar bg-warning" role="progressbar" style="width: 65%" aria-valuenow="20"
                            aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <!-- Progress -->
                    <!-- row -->
        ...
        <div class="card bg-info text-white  card-hover w-100">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center mt-4">
                    ...
                    <div class="ms-auto">
                        <h3 class="font-medium white-text mb-0">$351</h3><span class="white-text op-5">Jan 10 - Jan
                            20</span>
                    </div>
                </div>
            </div>
        ...
        <div class="card  card-hover w-100">
            <div class="card-body">
                ...
                <div class="d-flex no-block align-items-center mt-4">
                    <div class="">
                        <h3 class="font-medium mb-0">56.33%</h3><span class="">Total
                            Bounce</span>
                    </div>
                    <div class="ms-auto">
                        <div>
                    ...
                    <table class="table no-wrap v-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex no-block align-items-center">
                                        <div class="me-2"><img src="../../assets/images/users/d1.jpg"
                                ...
                                <td>
                                    <div class="popover-icon">
                                        ...
                                        <a class="btn-circle btn p-0 popover-item" href="javascript:void(0)"><img
                                                src="../../assets/images/users/1.jpg" class="rounded-circle" width="39"
                                                alt="" /></a>
                                        <a class="btn-circle btn btn-outline-secondary" href="javascript:void(0)">+</a>
                                    </div>
                                </td>
                                <td><i class="ri-checkbox-blank-circle-fill text-orange fs-4" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="In Progress"></i></td>
                                <td>35</td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex no-block align-items-center">
                                        <div class="me-2"><img src="../../assets/images/users/d2.jpg"
                                                alt="user" class="rounded-circle" width="45" /></div>
                                        <div class="">
                                ...
                                <td><i class="ri-checkbox-blank-circle-fill text-success fs-4" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="Active"></i></td>
                                <td>35</td>
                                <td class="blue-grey-text  text-darken-4 font-medium">$96K</td>
                            </tr> <!-- end row -->
                            <!-- start row -->
                            <tr>
                                <td>
                                    <div class="d-flex no-block align-items-center">
                                        <div class="me-2"><img src="../../assets/images/users/d3.jpg"
                                                alt="user" class="rounded-circle" width="45" /></div>
                                        <div class="">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex no-block align-items-center">
                                        <div class="me-2"><img src="../../assets/images/users/2.jpg"
                                                alt="user" class="rounded-circle" width="45" /></div>
                                        <div class="">
                    ...
                    <div class="comment-text w-100">
                        ...
                        <div class="comment-footer d-md-flex align-items-center">
                            ...
                            <span class="action-icons">
                                <a href="javascript:void(0)"><i data-feather="edit-3" class="feather-sm"></i></a>
                                <a href="javascript:void(0)"><i data-feather="check-circle"
                                        class="feather-sm"></i></a>
                                <a href="javascript:void(0)"><i data-feather="heart" class="feather-sm"></i></a>
                            </span>
                    ...
                    <div class="comment-text active w-100">
                        ...
                        <div class="comment-footer d-md-flex align-items-center">
                            ...
                            <span class="action-icons active">
                                <a href="javascript:void(0)"><i data-feather="edit-3" class="feather-sm"></i></a>
                                <a href="javascript:void(0)"><i data-feather="x-circle" class="feather-sm"></i></a>
                                <a href="javascript:void(0)"><i data-feather="heart"
                                        class="feather-sm text-danger"></i></a>
                            </span>
                            <div class="text-muted ms-auto mt-2 mt-md-0">April 14, 2016</div>
                        </div>
                    </div>
                    ...
                    <ul class="chat-list">
                        ...
                        <li class="chat-item">
                            ...
                            <div class="chat-content">
                                <h6 class="font-medium">James Anderson</h6>
                                <div class="box bg-light">Lorem Ipsum is simply dummy text of the
                        ...
                        <li class="chat-item">
                            ...
                            <div class="chat-content">
                                ...
                                <div class="box bg-light">Well we have good budget for the project
                                </div>
                            </div>
            ...
            <div class="card-body border-top">
                <div class="row">
                    ...
                    <div class="col-3 d-flex justify-content-end">
                        <a class="btn-circle btn-lg btn-cyan btn text-white" href="javascript:void(0)"><i
                                data-feather="send" class="fill-white feather-sm"></i></a>
                    </div>
                </div>
            </div>
        </div>
