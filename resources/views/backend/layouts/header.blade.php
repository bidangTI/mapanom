    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="{{ route('dashboard') }}">
            ...
            <span class="logo-text">
                <span
                    style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 20px; color: black"><b>SIPP
                        MAS</b></span>
            </span>
        </a>
        ...
        <a class="topbartoggler d-block d-md-none waves-effect waves-light" href="javascript:void(0)"
            ...
            aria-expanded="false" aria-label="Toggle navigation"><i class="ri-more-line fs-6"></i>
        </a>
    </div>
        ...
        <ul class="navbar-nav me-auto">
            <li class="nav-item d-none d-md-block"><a class="nav-link sidebartoggler waves-effect waves-light"
                    href="javascript:void(0)" data-sidebartype="mini-sidebar"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        class="feather feather-menu feather-sm">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href=""
                    ...
                    @if (Auth::user()->roles != 3)
                        <img src="{{ asset('backafs/assets/images/users/internal.png') }}" alt="user"
                            class="rounded-circle" width="31">
                    @else
                        <img src="{{ asset('backafs/assets/images/users/user.png') }}" alt="user"
                            class="rounded-circle" width="31">
                    @endif
                </a>
                <div class="dropdown-menu dropdown-menu-end user-dd animated flipInY">
                    ...
                    <a href="{{ route('pass-show') }}" class="dropdown-item" href="#">
